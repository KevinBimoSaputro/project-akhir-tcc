...
<center>
<h2>Pendataan Mahasiswa Berprestasi</h2> <br>
</center>
<body>
    <div class="mx-auto">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control" name="fakultas" id="fakultas">
                                ...
                                <option value="FTI" <?php if ($fakultas == "FTI") echo "selected" ?>>Fakultas Teknik Industri</option>
                                <option value="FTM" <?php if ($fakultas == "FTM") echo "selected" ?>>Fakultas Teknologi Mineral</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-12">
